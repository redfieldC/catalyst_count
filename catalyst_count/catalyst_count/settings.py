...
SECRET_KEY = "django-insecure-i)n8avyp3j&8%mft*l&tcd#@9&cp789p9guo1wblsmxscdc_2&"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ameya',  # replace with your database name
...
# Media files settings for large file uploads
MEDIA_URL = '/media/'
